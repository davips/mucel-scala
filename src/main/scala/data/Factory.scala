...
object Factory {
  ...
  //  def newOrg(rnd: Random, walls: Seq[Wall], intersect: Boolean = true, scale: Double = 1)(id: Int): Org = {
  ...
  def newCell(rnd: Random)(id: Int, x: Double, y: Double): Cell = {
  ...
  //  def planarian(id: Int, walls: Seq[Wall]): Org = {
